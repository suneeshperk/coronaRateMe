...
function scene:create( event )
    ...
    local topBg
    if rateMeUtilities.getOrientation() == "portrait" then
      topBg = display.newImage("plugin/RATE_ME/gray_top.png")
    else
      topBg = display.newImage("plugin/RATE_ME/gray_top_l.png")
    end
    ...
    if rateMeUtilities.getOrientation() == "landscape" then
      local topbgStars = display.newImage("plugin/RATE_ME/star_top_l.png")
    ...
    local middleBg
    if rateMeUtilities.getOrientation() == "portrait" then
      middleBg = display.newImage("plugin/RATE_ME/blue_centre.png")
    else
      middleBg = display.newImage("plugin/RATE_ME/blue_centre_l.png")
    end
    ...
    local bottomBg
    if rateMeUtilities.getOrientation() == "portrait" then
      bottomBg = display.newImage("plugin/RATE_ME/bottom_bg.png")
    else
      bottomBg = display.newImage("plugin/RATE_ME/bottom_bg_l.png")
    end
    ...
    for i = 0,4,1 do
      local star = display.newImage("plugin/RATE_ME/star.png")
    ...
    local rateNowButton
    if rateMeUtilities.getOrientation() == "portrait" then
      rateNowButton = display.newImage("plugin/RATE_ME/button_rate_now.png")
    else
      rateNowButton = display.newImage("plugin/RATE_ME/button_rate_now_l.png")
    end
    ...
    local remindMeButton = display.newImage("plugin/RATE_ME/button_remind.png")
    ...
    local noThanksButton = display.newImage("plugin/RATE_ME/button_no_thanks.png")
