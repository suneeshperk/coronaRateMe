...
function M.setAppIconUrl (val)
  appIconUrl = val
end

function M.setAppStoreId(val)
  appStoreId = val
end

function M.setAndroidPackageName (val)
  androidPackageName = val
end

function M.setAppName(val)
  appName = val
end
function M.setAlertInterval(first,later)
  firstAlertAfter = first
  laterAlertAfter = later
end
